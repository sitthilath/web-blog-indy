...
<div class="footer" style="background: gray;width:100%; height:60px;  text-align:center; color:white; margin-bottom:0%; ">
<br>      
<h5 >@copyright ສ້າງຂຶ້ນໂດຍທີມງານ ລຸງບ້ານນ້າ ຫາປາຢູ່ທົ່ງ Studio </h5>
</div>
</body>
</html>